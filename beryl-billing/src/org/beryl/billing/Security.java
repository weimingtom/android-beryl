...
import org.beryl.util.Base64;
import org.beryl.util.Base64DecoderException;
...
class Security {
     ...
     */
    public static ArrayList<VerifiedPurchase> verifyPurchase(IBillingSecurity billingSecurity, String signedData, String signature) {
        if (signedData == null) {
        ...
        if (!TextUtils.isEmpty(signature)) {
            ...
            String base64EncodedPublicKey = billingSecurity.getMarketPublicKey();
