...
public class Constants {
    ...
    public enum PurchaseState {
        ...
        public static PurchaseState valueOf(final int index) {
        	final PurchaseState[] values = PurchaseState.values();
            if (index < 0 || index >= values.length) {
                return CANCELED;
            }
            return values[index];
    ...
    public static final String ACTION_METHOD_CHECK_BILLING_SUPPORTED = 
    		"org.beryl.billing.METHOD_CHECK_BILLING_SUPPORTED";
    public static final String ACTION_METHOD_REQUEST_PURCHASE = 
    		"org.beryl.billing.METHOD_REQUEST_PURCHASE";
    public static final String ACTION_METHOD_RESTORE_TRANSACTIONS = 
    		"org.beryl.billing.METHOD_RESTORE_TRANSACTIONS";
    ...
    public static final String ACTION_CONFIRM_NOTIFICATION =
        "org.beryl.billing.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION =
        "org.beryl.billing.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS =
        "org.beryl.billing.RESTORE_TRANSACTIONS";
